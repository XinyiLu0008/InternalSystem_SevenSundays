            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p>Hi, </p>
                        <p>You have received a new order from client, <?= h($first_name) . " " . h($last_name) ?>, with a sale reference number of
                            <strong><?= h($id) ?></strong>. This is a notification that the client has made a new order from Seven Sundays.</p>
                        <p>For your reference, please find below information regarding the new order made by this customer:</p>
