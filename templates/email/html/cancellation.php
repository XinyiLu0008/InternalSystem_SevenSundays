                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p>The order for client, <?= h($first_name) . " " . h($last_name) ?>, with a sale reference number of
                            <strong><?= h($id) ?></strong>, has been successfully cancelled. This is a friendly reminder
                            that the client's order made on, <?= h($sales_date) ?>, with a quantity of <?= h($quantity) ?>
                            and a price of $<?= h($price) ?> has been cancelled.</p>
                        <p>For your reference, please find below information regarding the order cancellation
                            made by this customer:</p>
