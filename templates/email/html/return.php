                ...
                <tr>
                    <td align="left" bgcolor="#ffffff"
                        ...
                        <p>The order for client, <?= h($first_name) . " " . h($last_name) ?>, with a sale reference number of
                            <strong><?= h($id) ?></strong>, has been requested for order return. This is a friendly reminder
                            that the client's order made on, <?= h($sales_date) ?>, with a quantity of <?= h($quantity) ?>
                            and a price of $<?= h($price) ?> has been requested for return to SevenSundays.</p>
                        <p>For your reference, please find below information regarding the request for order return from this customer:</p>
