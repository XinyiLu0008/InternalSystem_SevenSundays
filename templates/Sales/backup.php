...
if ($userRole === 'admin') {
    ...
    $this->Breadcrumbs->add([
        ...
        [
            'title' => 'Order Detail',
            'url' => ['controller' => 'sales', 'action' => 'view',$sale->id],
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <h2 class="page-header">
                            <h2 class="d-block" style="font-size: 1.5rem; color: #5D51AF; font-weight: bold"><i class="fa fa-globe"></i>  SevenSundays</h2>
                                ...
                                <tr>
                                    ...
                                    <td><?php
                                        ...
                                        $resultsObject = $productsTable
                                            ...
                                            ->first(); ?>
                                        <?php
                                        $total=$this->Number->format($sale->price);
