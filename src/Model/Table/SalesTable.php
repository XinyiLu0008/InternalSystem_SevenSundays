 ...
 * @property \App\Model\Table\InventoriesTable&\Cake\ORM\Association\BelongsToMany $Inventories
 *
...
class SalesTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('Inventories', [
            'foreignKey' => 'sale_id',
            'targetForeignKey' => 'inventory_id',
