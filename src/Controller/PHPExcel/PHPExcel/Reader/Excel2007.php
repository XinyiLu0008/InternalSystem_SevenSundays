...
//
//                    Temporary Fix, If the cells in the file are merged, it will throw errors that the debugger cant fix
//                hence javascript is used to return to the previous page
//                    if (empty($xpath)) {
//                        ?>
<!--                        <script>-->
<!--                            history.back();-->
